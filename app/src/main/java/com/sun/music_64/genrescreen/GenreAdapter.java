...
public class GenreAdapter extends RecyclerView.Adapter<GenreAdapter.MyViewHolder> {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView mTextAuthName;
        public TextView mTextPosition;
        public ImageButton mImageShow;
        public ItemClickRecyclerView mItemClickRecyclerView;
        ...
        public void setOnItenClickListener(ItemClickRecyclerView itemClickListener) {
            this.mItemClickRecyclerView = itemClickListener;
        }

        public void bindData(int position) {
            mTextSongName.setText(mTracks.get(position).getTitle());
            mTextPosition.setText(String.valueOf(position));
            mTextAuthName.setText(mTracks.get(position).getArtist());
        }
    }
}
